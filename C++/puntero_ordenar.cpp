...
int main(){
    ...
    for (cont=0;cont<4;cont++){
        ...
        palabra[cont]= (char *) malloc((longitud+1)*sizeof(char)); 
				...
				// El +1 es para saber donde termina la palabra.
        ...
        strcpy(palabra[cont], aux); 
				// copia la cadena de caracteres, necesita la libreria string. (destino, origen); pasa del aux a una celda. 
        ...
        for(veces=1;veces<4;veces++){
            for (cont=0;cont<3;cont++){                        
               if (strcmp(palabra[cont], palabra[cont+1])>0){ 
			   			//strcmp sirve para comparar las letras de la palabra, sirve para ordenar alfabeticamente
			   			//si pones <0 ordena en  antialfabetico, si pones >0 ordena alfabeticamente
